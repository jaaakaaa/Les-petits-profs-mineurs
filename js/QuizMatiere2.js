...
var questions = [
	["Quelle image correspond à l'état gazeux?", "Image bleue", "Image rose", "Image verte", "1"],
	["Quelle image correspond à l'état liquide?", "Image bleue", "Image rose", "Image verte", "2"],
	["Quelle image correspond à l'état solide?", "Image bleue", "Image rose", "Image verte", "3"],["Si un objet est bleu, quelle est la couleur qu'il absorbe ?", "Orange", "Vert", "Rouge", "1"],
    ...
    ["3+2=?","1","2","3","4","5","6","5"],["Oui ou Non ?","oui","non","2"]
]
...
function Suivant()
{
    ...
    if (QenCours >= questions.length) 
    {
        ...
        xmlhttp.open("GET","/Les-petits-profs-mineurs/resultattoDB.php?section=Matiere&Numeroquiz=2&score="+String(score),true);
        xmlhttp.send();
