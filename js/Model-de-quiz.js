//Le nom doit etre de la forme Quiz[Chapitre][Numéro d'article].js par exemple QuizMatiere1.js

var score = 0

var questions = [
	["Question", "choix 1", "...", "choix n", "numéro de la bonne réponse"],
["exemple : Il pleut a Nancy","oui","non","1"]
]
...
function Suivant()
    ...
    if (QenCours >= questions.length)
        ...
        xmlhttp.open("GET","/Les-petits-profs-mineurs/resultattoDB.php?section=SECTION&Numeroquiz=N&score="+String(score),true);
        // SECTION ET N à modifier
        xmlhttp.send();
        } else 
        {
