...
var questions = [
	["Comment fait-on du blanc en synthèse additive ?", "On mélange les 3 couleurs primaires", "On mélange Bleu et Vert", "On mélange Rouge et Bleu", "1"],
	["Que se passe-t-il si on mélange les 3 couleurs primaires en synthèse soustractive ?", "Cela fait du Rouge", "Cela fait du Noir", "Cela fait du Blanc", "2"],
	["Je suis en vacances sur la plage. Je peux dessiner un crabe avec des pinceaux. Quelle synthèse va me servir ?", "La synthèse additive", "La synthèse additive et soustractive", "La synthèse soustractive", "3"]
];
...
function Suivant(){
    ...
    if (QenCours >= questions.length) {
        ...
        xmlhttp.open("GET","/Les-petits-profs-mineurs/resultattoDB.php?section=Lumiere&Numeroquiz=2&score="+String(score),true);
        xmlhttp.send();
        } else {
